...
//
const BotName = 'Markocop Bot'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/_dhndra_72'; // Nama Instagramlu cok
const whatsapplu = '0831-6388-6533'; // Nomor whatsapplu cok
